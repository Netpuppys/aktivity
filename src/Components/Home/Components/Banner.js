  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <div className="w-fit flex gap-6 pt-[2%] pb-[1%]">
        <button className="bg-gradient-to-r from-[#F6AB12] via-[#F12D0B] to-[#800437] text-white shadow-[0px_4px_10.1px_rgba(0,0,0,0.25)] font-medium">
          Get Started
        </button>
        <button className="bg-gradient-to-r from-[#F6AB12] via-[#F12D0B] to-[#800437] text-transparent bg-clip-text shadow-[0px_4px_10.1px_rgba(0,0,0,0.25)] font-medium">
          Book a Demo!
        </button>
      </div>
      ...
      <div className="flex items-end pb-[2%] w-[90%] mx-auto gap-[40px]">
        <img
          src={image1}
          alt=""
          className="rounded-3xl w-full aspect-[0.72/1]"
        />
        <div className="aspect-[0.65/1] bg-[#DC2B1B]  w-[70%] rounded-3xl flex flex-col justify-center items-center">
        ...
        <div className="aspect-[1.25/1] bg-white shadow-[0px_4px_10.2px_rgba(0,0,0,0.25)] w-full rounded-3xl">
        ...
        <div className="aspect-[0.65/1] bg-[#F78F18] w-[70%] rounded-3xl flex flex-col justify-center items-center">
        ...
        <div className="aspect-[0.72/1] relative w-full overflow-hidden rounded-3xl">
          <img
            src={image2}
            alt=""
